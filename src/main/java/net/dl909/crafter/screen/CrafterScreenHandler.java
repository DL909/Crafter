package net.dl909.crafter.screen;
...
import net.dl909.crafter.screen.slot.CrafterInputSlot;
import net.dl909.crafter.screen.slot.CrafterOutputSlot;
...
public class CrafterScreenHandler
    ...
    public CrafterScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inputInventory, PropertyDelegate propertyDelegate){
        super(Crafter.CRAFTER_3X3,syncId);
