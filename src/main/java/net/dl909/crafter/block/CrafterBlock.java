...
import net.dl909.crafter.recipe.RecipeCache;
import net.dl909.crafter.screen.VoidScreenHandler;
...
public class CrafterBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : CrafterBlock.checkType(type, Crafter.CRAFTER_BLOCK_ENTITY, CrafterBlockEntity::tickCrafting);
    }
